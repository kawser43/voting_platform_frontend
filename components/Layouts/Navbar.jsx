            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        <Link href="/winners" className="flex items-center bg-indigo-600 text-white px-3 py-1.5 text-[15px] rounded-md font-medium hover:bg-indigo-700 transition-colors shadow-sm group mr-2">
                ...
                <div className="relative flex flex-col w-64 max-w-xs h-full ml-auto bg-white shadow-xl overflow-y-auto">
                    <div className="px-4 py-6 flex-1">
                        ...
                        <div className="flex flex-col space-y-4">
                            <Link href="/winners" onClick={toggleMobileMenu} className="flex items-center bg-indigo-600 text-white px-4 py-2 rounded-md font-medium hover:bg-indigo-700 transition-colors shadow-sm group">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-yellow-300" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                </svg>
                                Winners
